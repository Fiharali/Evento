...
<div class="box">
    ...
    <div class="ticket">
        <span class="airline">{{$event->title}}</span>
        <span class="airline airlineslip">{{$event->title}}</span>
        ...
        <div class="content">
            ...
            <div class="sub-content">
                ...
                <span class="name">UER NAME<br><span>{{$event->organisator->name}}</span></span>
                ...
                <span class="name nameslip">Event place<br><span>{{$event->place}}</span></span>
            </div>
        </div>
